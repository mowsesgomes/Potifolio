create or replace function public.admin_get_portfolio_content()
returns jsonb
language sql
stable
security definer
...
as $admin_content$
  select case
    when not public.is_portfolio_admin() then
...
grant execute on function public.admin_get_portfolio_content() to authenticated;
